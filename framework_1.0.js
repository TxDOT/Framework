...
// <!--drawText(theText,theX,theY,theColor) 
// accepts a string, xy location, and color to draw a text element on the canvas element-->
...
function drawText(theText,theX,theY,theColor) {
    var canvas = document.getElementById("myCanvas");
    var ctx = canvas.getContext("2d");
